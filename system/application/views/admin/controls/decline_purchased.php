              ...
              <div class="col-12">
                <div class="card">
				  <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link " href="<?php echo site_url("administrator/reports/sales");?>"  >SALES REPORT</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="<?php echo site_url("administrator/reports/declined");?>" >DECLINE PURCHASE</a>
                      </li>
                     
                    </ul>
                  <div class="card-header">
                    <h4>SALES RECORDS (DECLINED) </h4>
                  </div>
                  <div class="card-body">
