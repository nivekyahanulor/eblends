              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="<?php echo site_url("user/wallet/binary");?>">BINARY</a>
                      </li> 
                      <li class="nav-item">
                        <a class="nav-link " href="<?php echo site_url("user/wallet/empathy");?>">EMPATHY BONUS</a>
                      </li> 
                      <li class="nav-item">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered" id="genealogy-table">
                        <thead>
                          <tr>
                            <th class="text-center"> EARNING DESCRIPTION     </th>
						...
						<tbody>
							...
							<tr>
								<td class="text-center"><?php echo $row->EarnDesc;?></td>
